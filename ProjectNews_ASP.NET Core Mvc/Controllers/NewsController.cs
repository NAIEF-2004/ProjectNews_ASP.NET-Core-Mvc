...
namespace ProjectNews_ASP.NET_Core_Mvc.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Image,Topic,Data,CategoryId")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Image,Topic,Data,CategoryId")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
